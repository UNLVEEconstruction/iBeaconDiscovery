package com.example.jeepark.ibeacondiscovery;
...
public class MainActivity extends AppCompatActivity {
    ...
    private HandleFileReadWrite fileHandler;    //handler to readwrite object
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //initialize objects
        fileHandler = new HandleFileReadWrite(context);
        ...
        startButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (scanEnable) {
                    ...
                    fileHandler.open(fileName, HandleFileReadWrite.fileOperator.OPEN_WRITE);
        ...
        HandleFileReadWrite reader = new HandleFileReadWrite(context);
    ...
    protected void onStop() {
        super.onStop();
        Log.i(TAG, "ON STOP");
        HandleFileReadWrite writer = new HandleFileReadWrite(context);
        writer.open(MAJORS_STORAGE_FILE, HandleFileReadWrite.fileOperator.OPEN_WRITE);
